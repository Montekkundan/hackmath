...
function QuestionChat({question}: {question: string}) {
    const {
        completion,
        input,
        stop,
    ...
    return (
        <div className="w-full sm:max-w-xl md:max-w-xl lg:max-w-3xl sm:px-4 flex flex-col stretch">
            {conversation.length === 0 && (
                <EmptyScreen question={question} submitMessage={submitFromEmptyScreen} />
            )}
